...
Free on-site trainings are also possible, subject to our capacity and vetting of any requests (travel/accommodation costs need to be reimbursed).

The "Shadowserver-in-a-box" IntelMQ + ELK VM/Docker was supported by the cyber capacity building project under the ECOWAS-G7 partnership for cybersecurity, the "Joint Platform for Advancing Cyber Security" (JPAC) in West Africa. The project was launched by the ECOWAS Commission in collaboration with Germany's G7 presidency in 2022, commissioned by the German Federal Foreign Office and the European Union Commission in 2023, and implemented by Deutsche Gesellschaft für Internationale Zusammenarbeit (GIZ) GmbH.

![image](images/dashboard2.png)

![image](images/intelmq.png)
